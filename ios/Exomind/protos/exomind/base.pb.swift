...
struct Exomind_Base_CollectionChild {
  ...
  var addedDate: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _addedDate ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_addedDate = newValue}
  }
  /// Returns true if `addedDate` has been explicitly set.
  var hasAddedDate: Bool {return self._addedDate != nil}
  /// Clears the value of `addedDate`. Subsequent reads from it will return its default value.
  mutating func clearAddedDate() {self._addedDate = nil}
...
struct Exomind_Base_Postponed {
  ...
  var entity: Exocore.Exocore_Index_Reference {
    get {return _entity ?? Exocore.Exocore_Index_Reference()}
...
extension Exomind_Base_CollectionChild: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Exomind_Base_CollectionChild, rhs: Exomind_Base_CollectionChild) -> Bool {
    ...
    if lhs._addedDate != rhs._addedDate {return false}
