...
pub mod my_game {
    ...
    #[allow(non_camel_case_types)]
    const ENUM_VALUES_ANY: [Any; 4] = [Any::NONE, Any::Monster, Any::Weapon, Any::Pickup];

    #[allow(non_camel_case_types)]
    const ENUM_NAMES_ANY: [&'static str; 4] = ["NONE", "Monster", "Weapon", "Pickup"];
    ...
    impl<'a> Pickup<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
            _args: &'args PickupArgs,
        ) -> flatbuffers::WIPOffset<Pickup<'bldr>> {
