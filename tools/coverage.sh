...
export RUSTUP_TOOLCHAIN=nightly-2020-06-21 # if changed, change in push-tester.yml. Use https://rust-lang.github.io/rustup-components-history/ to get a nightly with all components
...
grcov $COVERAGE_DIR/ccov.zip -s . -t lcov --llvm -o $COVERAGE_DIR/lcov.info \
	...
	--ignore "cli/*" \
	--ignore "/*" \
	--ignore "core/src/protos/generated/*"
