...
pub mod envelope {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_from_node_id(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
...
pub mod node {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_public_key(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false).unwrap()
    }
    #[inline]
    ...
    #[inline]
    pub fn set_address(&mut self, value: ::capnp::struct_list::Reader<'_,crate::common_capnp::node_address::Owned>) -> ::capnp::Result<()> {
