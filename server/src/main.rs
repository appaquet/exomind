...
use exocore::{core::time::Utc, protos::prost::{ProstAnyPackMessageExt, ProstTimestampExt}, protos::store::{Entity, Reference, Trait}, store::{entity::EntityExt, mutation::MutationBuilder, store::Store}};
...
async fn main() {
    ...
    exocore::core::logging::setup::<String>(Some(LevelFilter::from_str(&opt.logging_level).unwrap()), None);
