    ...
    if env::var("GENERATE_PROTOS").is_ok() {
...

        {
            ...
            config
                ...
                .field_attribute("EntityIndexConfig.pending_index_config", "#[serde(default)]")
                .field_attribute("EntityIndexConfig.chain_index_config", "#[serde(default)]")
                ...
                .field_attribute("MutationIndexConfig.iterator_page_size", "#[serde(default)]")
                .field_attribute("MutationIndexConfig.iterator_max_pages", "#[serde(default)]")
